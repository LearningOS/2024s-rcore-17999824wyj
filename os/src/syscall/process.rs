...
use crate::{
    config::MAX_SYSCALL_NUM, mm::translated_byte_buffer, task::{
        change_program_brk, current_user_token, exit_current_and_run_next, get_current_task_info, select_cur_task_to_mmap, select_cur_task_to_munmap, suspend_current_and_run_next, TaskStatus
    }, timer::get_time_us
};
...
pub fn sys_mmap(start: usize, len: usize, port: usize) -> isize {
    ...
    select_cur_task_to_mmap(start, len, port)
}

// YOUR JOB: Implement munmap.
pub fn sys_munmap(start: usize, len: usize) -> isize {
    trace!("kernel: sys_munmap");
    select_cur_task_to_munmap(start, len)
}
